...
public class RedBits implements ModInitializer {
	...
	// Buttons
	public final static Block OAK_LARGE_BUTTON = new LargeButtonBlock(BlockSetType.OAK, AbstractBlock.Settings.create().noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY));
	public final static Block SPRUCE_LARGE_BUTTON = new LargeButtonBlock(BlockSetType.SPRUCE, AbstractBlock.Settings.create().noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY));
	public final static Block BIRCH_LARGE_BUTTON = new LargeButtonBlock(BlockSetType.BIRCH, AbstractBlock.Settings.create().noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY));
	public final static Block JUNGLE_LARGE_BUTTON = new LargeButtonBlock(BlockSetType.JUNGLE, AbstractBlock.Settings.create().noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY));
	...
	public final static Block POLISHED_BLACKSTONE_LARGE_BUTTON = new LargeButtonBlock(BlockSetType.POLISHED_BLACKSTONE, AbstractBlock.Settings.create().noCollision().strength(0.5F).pistonBehavior(PistonBehavior.DESTROY));
	...
	public final static Block JUNCTION = new JunctionBlock(AbstractBlock.Settings.create().breakInstantly().sounds(BlockSoundGroup.WOOD).pistonBehavior(PistonBehavior.DESTROY));
	...
	private void registerBlock(String name, Block block) {
		Registry.register(Registries.BLOCK, Identifier.of(NAMESPACE, name), block);
	}
